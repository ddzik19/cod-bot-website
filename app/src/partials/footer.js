	...
	return (
		<div className="p-5 md:w-full grid grid-cols-2">
			<div className="text-center md:text-right md:pr-10">
				...
				<Button className={"py-3"} href={"https://discord.com/api/oauth2/authorize?client_id=934543703572369448&permissions=0&scope=bot"} children={"Add Commander-B"}/>
			...
			<ul className="text-center md:text-left md:pl-10 mdlist-none text-[#b3b8cd] footer-list">
				...
				<List href={"https://discord.com/api/oauth2/authorize?client_id=934543703572369448&permissions=0&scope=bot"} children={"Add Commander-B"}/>
